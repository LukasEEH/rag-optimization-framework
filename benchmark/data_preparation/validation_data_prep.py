...
result_df = qa_df.query('positive_ctx_idx == 0').iloc[1:17]
result_df = pd.concat([result_df, qa_df.query('positive_ctx_idx == 1').iloc[2:18]])
result_df = pd.concat([result_df, qa_df.query('positive_ctx_idx == 2').iloc[2:18]])
result_df = pd.concat([result_df, qa_df.query('positive_ctx_idx == 3').iloc[2:18]])
result_df = pd.concat([result_df, qa_df.query('positive_ctx_idx == -1').iloc[2:22]])
...
result_df = mc_df.query('correct_answer_num == 1').iloc[1:12]
result_df = pd.concat([result_df, mc_df.query('correct_answer_num == 2').iloc[1:12]])
result_df = pd.concat([result_df, mc_df.query('correct_answer_num == 3').iloc[1:12]])
result_df = pd.concat([result_df, mc_df.query('correct_answer_num == 4').iloc[1:12]])
...
result_df = fc_df.query('claim_label == 0').iloc[2:23]
result_df = pd.concat([result_df, fc_df.query('claim_label == 1').iloc[2:23]])
result_df = pd.concat([result_df, fc_df.query('claim_label == 2').iloc[2:22]])
...
mh_df = mh_df[~mh_df['id'].isin(target_ids)]
result_df = mh_df.sort_values('id').sample(n=70, random_state=42)
